...
<div class="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5">
    <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
        <div class="md:flex w-full">
            <div class="md:block w-1/2 bg-indigo-500 py-10 px-10">
                <img
                    src="https://static1.educaedu-colombia.com/adjuntos/12/00/28/universidad-santo-tom-s---seccional-bucaramanga-002869_large.jpg"
                    class="basis-full"
                    alt="Sample image"
                    />
                ...
                <div>
                    <div class="flex -mx-3">
                        <div class="w-1/2 px-3 mb-5">
                            <label for="name" class="text-xs font-semibold px-1">Nombre completo</label>
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                <input type="text" name="name" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Nombre">
                                @error('name')
                        ...
                        <div class="w-1/2 px-3 mb-5">
                            <label for="username" class="text-xs font-semibold px-1">Nombre Usuario</label>
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                <input type="text" name="username" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Usuario">
                            </div>
                        </div>
                    </div>
                    <div class="flex -mx-3">
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <label for="programa" class="text-xs font-semibold px-1">Programa</label>
                            <div class="flex">
                                ...
                                <input type="text" name="programa" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="programa">
                            </div>
                        </div>
                    </div>
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <label for="semestre" class="text-xs font-semibold px-1">Semestre</label>
                            <div class="flex">
                                ...
                                <input type="text" name="semestre" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="semestre">
                            </div>
                        </div>
                    </div>
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <label for="celular" class="text-xs font-semibold px-1">Celular</label>
                            <div class="flex">
                                ...
                                <input type="text" name="celular" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="celular">
                            </div>
                        </div>
                    </div>
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <label for="direccion" class="text-xs font-semibold px-1">Dirección</label>
                            <div class="flex">
                                ...
                                <input type="text" name="direccion" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="direccion">
                            </div>
                        </div>
                    </div>
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <label for="presentacion" class="text-xs font-semibold px-1">Presentación</label>
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-card-text text-gray-400 text-lg"></i></div>
                                <input type="text" name="presentacion" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="descripción">
                            </div>
                        </div>
                    </div>
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <label for="genero" class="text-xs font-semibold px-1">Género</label>
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-gender-male-female text-gray-400 text-lg"></i></div>
                                <input type="text" name="genero" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="género">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <input type="submit" value="REGISTRATE AHORA" class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">
                        </div>
                    </div>
                </div>
            </form>
